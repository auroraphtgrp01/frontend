...
import { Plus, Search, Filter, Eye, Calendar, MoreHorizontal } from 'lucide-react'
...
import { isOrderPaymentAvailable } from '@/lib/order-payment'
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        {isOrderPaymentAvailable(order) && (
                          <DropdownMenuItem asChild>
                            <Link to={`/app/orders/${order.id}?action=pay`}>
                              Pay Now
                            </Link>
                          </DropdownMenuItem>
                        )}
